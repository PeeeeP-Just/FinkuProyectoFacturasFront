...
import { getComprasDetalle } from '../lib/database';
...
export const ComprasDetalleModal: React.FC<ComprasDetalleModalProps> = ({
  ...
  const fetchDetalle = async () => {
    ...
    try {
      ...
      const detalleData = await getComprasDetalle(compraId);
        ...
        <div className="px-6 py-4 bg-slate-50 border-b border-slate-200">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="bg-white rounded-xl p-4">
              ...
              <p className="text-lg font-semibold text-slate-900 mt-1">{proveedor}</p>
              {rutProveedor && (
                <p className="text-xs text-slate-500 mt-1">{rutProveedor}</p>
              )}
            </div>
            <div className="bg-white rounded-xl p-4">
              <div className="flex items-center space-x-2">
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden">
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-16">
              ...
              <p className="text-slate-400 text-sm">No se encontraron líneas de detalle para esta compra</p>
            </div>
          ) : (
